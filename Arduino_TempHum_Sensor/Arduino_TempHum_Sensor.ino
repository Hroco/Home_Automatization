...
char userDB[] = "";                //db username
char passwordDB[] = "";         //db password
...
void loop(){  
  ...
  if (currentMillis - previousMillis >= interval) {
    ...
    if (isnan(newT)) {
      ...
      t = newT;
      char INSERT_SQLT[] = "INSERT INTO x.y (entity, value, location) VALUES ('temp', %f , 'detska_izba')";
    ...
    if (isnan(newH)) {
      ...
      h = newH;
      char INSERT_SQLH[] = "INSERT INTO x.y (entity, value, location) VALUES ('hum', %f , 'detska_izba')";
